...
MODEL_PATH = "mnist_model_1.keras"  # <-- make sure this filename matches exactly what you saved
...
class DigitApp:
    ...
    def predict(self):
        try:
            ...
            # FIX: model expects shape (batch, 28, 28, 1) — the trailing 1 is
            # the channel dimension used by Conv2D(..., input_shape=(28,28,1))
            ...
            # Show the error in the GUI too, not just the terminal,
            # so it's obvious something failed when you click Predict.
